 ...
 * [hokeylization дар npm](https://www.npmjs.com/package/hokeylization)
 ...
 Шумо инчунин метавонед феҳристи файлҳоро тарҷума кунед. hokeylization хоҳад recursively ташриф ҳар
 ...
 ** ОГОҲИИ КАЛОН**: Ҳангоми тарҷумаи директорияҳо, ** НАМЕКУНЕД** директорияи баромадро муайян накунед
 ки дар дохили феҳристи вуруди шумост! Агар шумо ин корро кунед, шумо хоҳед кард:
 * боиси рекурсияи беохир
 * ҳисоби Google-и худро иҷро кунед
 * диски худро пур кунед
 * камтар вақтхушӣ кунед

 Дар ин ҷо як мисоли он чизест, ки * набояд кард*:
 ...
 * Дар атрофи матн дар дохили `backticks` "тарҷума нест" ҷойгир карда мешавад, то боварӣ ҳосил кунад, ки онҳо тарҷума нашудаанд
 ...
 `filter` " дар ҷойҳои зерин ҷустуҷӯ карда мешавад (бо `.js` ба филтр замима карда мешавад
 ном, агар он аллакай бо `.js` тамом нашавад)
 * Феҳристи ҷорӣ
 ...
 * Дарунсохт [Феҳристи филтрҳо](https://github.com/cobbzilla/hokeylization/tree/master/util/filter)
 ...
 #### Параметрҳои филтр
 Сатри `filter` метавонад якчанд калима бошад. Дар ин ҳолат, калимаи аввал номи филтр аст, ва
 калимаҳои боқимонда ҳамчун аргумент ба функсияи `filter` дода мешаванд
 ...
 *Ҳангоми тавлиди индексҳо, шумо метавонед танҳо як манбаи вуруд дошта бошед*
 ...
 `-A` / `--index-template` истифода баред, то муайян кунед, ки чӣ гуна баромади индекс формат карда шудааст. Шумо метавонед 'html' -ро муайян кунед,
