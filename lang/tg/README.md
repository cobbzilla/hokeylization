 ...
 * феҳристи файлҳо, ба таври рекурсивӣ
 ...
 ба **[ҳар забоне, ки аз ҷониби Google Translate дастгирӣ мешавад](../README.md)!**
 ...
 * Шумо бо сохтори якхелаи феҳрист ва файлҳо дар `es` ва `de` хоҳед ёфт, ки шумо дар зери `en`
 ...
 Hokeylizer корҳоро хуб ҳал мекунад, аммо бо файлҳои қайдкунӣ, шумо метавонед аксар вақт ин мушкилотро пайдо кунед:
 ...
 * Дар атрофи матн дар дохили `backticks` "тарҷума нест" ҷойгир карда мешавад, то боварӣ ҳосил кунад, ки онҳо тарҷума нашудаанд
 ...
 Арзиши ин хосият бояд роҳ ба файли JS бошад, ки функсияи бо номи `filter`

 Функсияи `filter` бояд `async` , зеро `await` " ба он даъват карда мешавад

 Пеш аз навиштани файлҳо ба диск, тамоми мундариҷаи файл ҳамчун сатр ба вазифаи `filter` дода мешавад.

 Арзиши бозгашт аз функсияи `filter` он чизест, ки воқеан ба анбор навишта мешавад
