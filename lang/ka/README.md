 ...
 * ფაილების დირექტორია, რეკურსიულად
 ...
 ეს README.md დოკუმენტი ითარგმნა თავად hokeylization ინსტრუმენტის გამოყენებით,
 **[Google Translate-ის მიერ მხარდაჭერილი ყველა ენაზე](../README.md)!**
 ...
 * ნაკლებად გაერთეთ
 ...
 აქ არის მაგალითი იმისა, რაც *არ უნდა გააკეთოთ*:
 ...
 * თქვენ მიიღებთ იდენტური დირექტორიის სტრუქტურას და ფაილებს `es` და `de` , როგორიც გაქვთ `en`
 ...
 Hokeylizer კარგად უმკლავდება საკითხებს, მაგრამ ჩანაწერის ფაილებით, ხშირად შეიძლება შეგექმნათ ეს პრობლემები:
