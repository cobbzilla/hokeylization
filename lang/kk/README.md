Хокейлизация
 =============
 Атауы портманто, яғни «хокей локализациясы»

 Бұл хоккей, өйткені ол өте қарапайым: ол Google Translate-ге жолдарды жібереді

 Сіз аудара аласыз:
 * хабарларды қамтитын JavaScript нысаны
 * файлдар каталогы, рекурсивті

 # Мұны басқа тілде оқыңыз
 Бұл README.md құжаты хокейлизация құралының өзі арқылы аударылған,
 **[Google Translate қолдайтын барлық тілге](../README.md)!**
 ...
 * жақсырақ аударма ұсынысын ұсыныңыз
 * **Рақмет сізге!**
 ...
 * Соңында `es` және `de` ішіндегі бірдей каталог құрылымы мен файлдары 'en' астында `en`
 ...
 Hokeylizer заттарды жақсы өңдейді, бірақ таңбалау файлдарымен сіз жиі келесі мәселелерге тап болуыңыз мүмкін:
 ...
 * «Аударма жоқ» орамы мәтіннің айналасына аударылмағанына көз жеткізу үшін `backticks` белгілер» ішінде орналастырылады.
 ...
 шығысты файлдық жүйеге жазбас бұрын сүзу үшін

 Бұл опцияның мәні `filter` деп аталатын функцияны экспорттайтын JS файлына жол болуы керек

 `filter` функциясы `async` синхронды» болуы керек, себебі ол `await` » шақырылады

 Файлдар дискіге жазылмас бұрын, бүкіл файл мазмұны жол ретінде `filter` функциясына жіберіледі.

 `filter` функциясынан қайтарылатын мән - бұл нақты жадқа жазылатын нәрсе

 Осылайша, сіз ақырында не жазылатынын толықтай басқара аласыз

 ### Көмектесіңдер
 Анықтаманы көрсету үшін `-h` / `--help` пайдаланыңыз

 ## Аударма құтты болсын!
