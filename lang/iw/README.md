 ...
 * ספריית קבצים, רקורסיבית
 ...
 # קרא את זה בשפה אחרת
 מסמך README.md זה תורגם, באמצעות כלי ההקליזציה עצמו,
 אל **[בכל שפה הנתמכת על ידי Google Translate](../README.md)!**
 ...
 * בסופו של דבר יהיה לך מבנה ספריות זהה וקבצים בתוך `es` ו `de` de` כמו שיש לך תחת `en`
 ...
 Hokeylizer מטפל בדברים בצורה הגונה, אבל עם קבצי סימון, אתה עלול לעתים קרובות את הבעיות האלה:
