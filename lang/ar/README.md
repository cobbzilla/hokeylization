 ...
 * [hokeylization on npm] (https://www.npmjs.com/package/hokeylization)
 ...
 سأقدر بصدق حتى أصغر [مساهمة شهرية عبر Patreon] (https://www.patreon.com/cobbzilla)
 ...
 إذا كنت تعمل من الكود المصدري ، فيمكنك أيضًا وضعها في ملف `.env` في المصدر
 ...
 حتى نهاية كائن JS. تتم إعادة كتابة الملف بأكمله دائمًا.
 ...
 * أقل متعة
 ...
 عند تشغيل هذا ، تتم كتابة الملفات المترجمة إلى `templates/es` ، وبالتالي تصبح جديدة
 ...
 * ستنتهي ببنية دليل وملفات متطابقة داخل `es` `de` كما لو كانت ضمن `en`
 ...
 مرر علامة `-H` / `--handlebars` - Handlebars` ولن تتم ترجمة أي شيء بداخل `{{ ... }}`
 ...
 يتعامل Hokeylizer مع الأمور بشكل لائق ، ولكن مع ملفات markdown ، قد تواجه في كثير من الأحيان هذه المشكلات:
 ...
 * يتم ترجمة كتل التعليمات البرمجية. لا تعرف خدمة الترجمة من Google ما الذي يعتبره تخفيض السعر في الكود وما لا يعرفه
