 ...
 * ֆայլերի գրացուցակ, ռեկուրսիվ
 ...
 Այս README.md փաստաթուղթը թարգմանվել է՝ օգտագործելով հենց hokeylization գործիքը,
 դեպի **[Google Translate-ի կողմից աջակցվող յուրաքանչյուր լեզու](../README.md)!**

 Ես վստահ եմ, որ դա կատարյալ չէ, բայց հուսով եմ, որ ավելի լավ է, քան ոչինչ:

 [🇸🇦 արաբերեն](../ar/README.md)
 [🇧🇩 բենգալերեն](../bn/README.md)
 [🇩🇪 գերմաներեն] (lang/de/README.md)
 [🇺🇸 Անգլերեն] (lang/en/README.md)
 [🇪🇸 իսպաներեն] (lang/es/README.md)
 [🇫🇷 ֆրանսերեն] (lang/fr/README.md)
 [🇹🇩 Հաուսա] (lang/ha/README.md)
 [🇮🇳 հինդի] (lang/hi/README.md)
 [🇮🇩 ինդոնեզերեն](../id/README.md)
 [🇮🇹 Իտալերեն] (lang/it/README.md)
 [🇯🇵 ճապոներեն](../ja/README.md)
 [🇰🇷 կորեերեն] (lang/ko/README.md)
 [🇮🇳 Մարանթի] (lang/mr/README.md)
 [🇵🇱 լեհերեն](../pl/README.md)
 [🇧🇷 պորտուգալերեն](../pt/README.md)
 [🇷🇺 ռուսերեն](../ru/README.md)
 [🇰🇪 Սուահիլի] (lang/sw/README.md)
 [🇵🇭 Տագալերեն](../tl/README.md)
 [🇹🇷 թուրքերեն](../tr/README.md)
 [🇵🇰 ուրդու] (lang/ur/README.md)
 [🇻🇳 Վիետնամերեն] (lang/vi/README.md)
 ...
 * սիրով առաջարկեք ավելի լավ թարգմանության առաջարկ
 * **Շնորհակալություն!**
 ...
 * Դուք կունենաք նույնական գրացուցակի կառուցվածք և ֆայլեր՝ `es` և `de` , ինչպես դուք ունեք `en` ի տակ:
 ...
 Hokeylizer-ը լավ է վարվում իրերի հետ, բայց նիշերի ֆայլերի դեպքում դուք հաճախ կարող եք առաջացնել հետևյալ խնդիրները.
