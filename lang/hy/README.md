 ...
 * «Ոչ թարգմանել» փաթաթան կտեղադրվի տեքստի շուրջ `backticks` -ի շրջանակներում՝ ապահովելու, որ դրանք թարգմանված չեն:
 ...
 Այս ընտրանքի արժեքը պետք է լինի ուղի դեպի JS ֆայլ, որը արտահանում է `filter` անունով ֆունկցիա

 `filter` ֆունկցիան պետք է լինի `async` քանի որ `await`

 Նախքան ֆայլերը սկավառակի վրա գրվելը, ֆայլի ամբողջ բովանդակությունը կփոխանցվի `filter` ֆունկցիային որպես տող
