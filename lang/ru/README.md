Хокейлизация
 ==============
 Название представляет собой портмоне, что означает «хоккейная локализация».

 Это обман, потому что он очень прост: он отправляет строки в Google Translate.

 Вы можете перевести:
 * объект JavaScript, содержащий сообщения
 * каталог файлов, рекурсивно

 # Прочтите это на другом языке
 Этот документ README.md был переведен с использованием самого инструмента хокейлизации,
 на **[все языки, поддерживаемые Google Translate](../README.md)!**

 Я уверен, что это не идеально, но я надеюсь, что это лучше, чем ничего!

 [🇸🇦 арабский] (lang/ar/README.md)
 [🇧🇩 Бенгальский] (lang/bn/README.md)
 [🇩🇪 Немецкий] (lang/de/README.md)
 [🇺🇸 английский](../en/README.md)
 [🇪🇸 испанский](язык/ис/README.md)
 [🇫🇷 Французский] (lang/fr/README.md)
 [🇹🇩 Хауса](../ha/README.md)
 [🇮🇳 Хинди](../hi/README.md)
 [🇮🇩 Индонезийский] (lang/id/README.md)
 [🇮🇹 Итальянский](язык/it/README.md)
 [🇯🇵 Японский](../ja/README.md)
 [🇰🇷 Корейский] (lang/ko/README.md)
 ...
 **[📚 ... Все языки ...](../README.md)**
 ...
 Этот конкретный перевод оригинального [README](https://github.com/cobbzilla/yuebing/blob/master/README.md)
 может быть ошибочным -- *исправления очень приветствуются!* Пожалуйста, отправьте [запрос на извлечение на GitHub](https://github.com/cobbzilla/yuebing/pulls),
 или, если вам неудобно это делать, [откройте вопрос] (https://github.com/cobbzilla/yuebing/issues)
 ...
 * просьба предложить лучший перевод
 * **Спасибо!**
 ...
 * В итоге вы получите идентичную структуру каталогов и файлы в `es` и `de` , как и в `en`
 ...
 Hokeylizer справляется со всем прилично, но с файлами уценки вы часто можете столкнуться с такими проблемами:
