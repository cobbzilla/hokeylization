 ...
 * ফাইলগুলির একটি ডিরেক্টরি, পুনরাবৃত্তিমূলকভাবে
 ...
 এই README.md নথিটি অনুবাদ করা হয়েছে, হোকিলাইজেশন টুল ব্যবহার করে,
 **[Google অনুবাদ দ্বারা সমর্থিত প্রতিটি ভাষায়](../README.md)!**
 ...
 * অনুগ্রহ করে একটি ভাল অনুবাদের একটি পরামর্শ অফার করুন
 * **ধন্যবাদ!**
 ...
 * আপনি একটি অভিন্ন ডিরেক্টরি কাঠামো এবং `es` এবং `de` এর মধ্যে ফাইলগুলি নিয়ে শেষ করবেন যেমন আপনি `en` এর অধীনে আছে
 ...
 Hokeylizer জিনিসগুলি ভালভাবে পরিচালনা করে, কিন্তু মার্কডাউন ফাইলগুলির সাথে, আপনি প্রায়শই এই সমস্যাগুলি দেখতে পারেন:
 ...
 * একটি "অনুবাদ নয়" র‍্যাপার `backticks` এর মধ্যে পাঠ্যের চারপাশে স্থাপন করা হবে যাতে সেগুলি অনুবাদ করা না হয়।
 ...
 এই বিকল্পের মান অবশ্যই একটি JS ফাইলের পাথ হতে হবে যা `filter` নামের একটি ফাংশন রপ্তানি করে
