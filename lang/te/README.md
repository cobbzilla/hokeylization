హోకీలైజేషన్
 =============
 పేరు పోర్ట్‌మాంటో, అంటే 'హాకీ స్థానికీకరణ'

 ఇది చాలా సులభం ఎందుకంటే ఇది హాకీ: ఇది Google అనువాదానికి స్ట్రింగ్‌లను పంపుతుంది

 మీరు అనువదించవచ్చు:
 * సందేశాలను కలిగి ఉన్న జావాస్క్రిప్ట్ ఆబ్జెక్ట్
 * ఫైల్‌ల డైరెక్టరీ, పునరావృతంగా

 # దీన్ని వేరే భాషలో చదవండి
 ఈ README.md పత్రం hokeylization సాధనాన్ని ఉపయోగించి అనువదించబడింది,
 లోకి **[Google అనువాదం ద్వారా మద్దతిచ్చే ప్రతి భాష](../README.md)!**
 ...
 * మంచి అనువాద సూచనను దయచేసి అందించండి
 * **ధన్యవాదాలు!**
 ...
 * మీరు ఒకేలా డైరెక్టరీ నిర్మాణం మరియు ఫైల్‌లను `es` మరియు `de` లో మీరు `en` కింద కలిగి ఉంటారు
 ...
 Hokeylizer విషయాలను చక్కగా నిర్వహిస్తుంది, కానీ మార్క్‌డౌన్ ఫైల్‌లతో, మీరు తరచుగా ఈ సమస్యలను ఎదుర్కొంటారు:
 ...
 * అవి అనువదించబడలేదని నిర్ధారించుకోవడానికి `backticks` లోపల టెక్స్ట్ చుట్టూ "అనువాదం లేదు" రేపర్ ఉంచబడుతుంది
 ...
 ## అనువదిస్తున్నందుకు సంతోషంగా ఉంది!
