 ...
 * директоријум фајлова, рекурзивно
 ...
 Овај РЕАДМЕ.мд документ је преведен, користећи сам алат за хокеилизацију,
 на **[сваки језик који подржава Гоогле преводилац](ланг/РЕАДМЕ.мд)!**
 ...
 * На крају ћете имати идентичну структуру директоријума и датотеке унутар `es` и `de` као што имате под `en`
 ...
 Хокеилизер се прилично добро носи са стварима, али са мардовн фајловима често можете имати ове проблеме:
