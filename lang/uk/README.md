Хокеїлізація
 ==============
 Назва — портманто, що означає «хокейна локалізація».

 Це дивно, тому що воно дуже просте: воно надсилає рядки до Google Translate

 Ви можете перекласти:
 * об’єкт JavaScript, що містить повідомлення
 * каталог файлів, рекурсивно

 # Прочитайте це іншою мовою
 Цей документ README.md було перекладено за допомогою самого інструменту hokeylization,
 на **[кожну мову, яку підтримує Перекладач Google](../README.md)!**
 ...
 **[📚 ... Усі мови ...](../README.md)**
 ...
 Цей конкретний переклад оригіналу [README](https://github.com/cobbzilla/yuebing/blob/master/README.md)
 може мати недоліки -- *виправлення дуже вітаються!* Надішліть [запит на витягування на GitHub](https://github.com/cobbzilla/yuebing/pulls),
 або якщо вам не зручно це робити, [відкрийте проблему](https://github.com/cobbzilla/yuebing/issues)
 ...
 * будь ласка, запропонуйте кращий переклад
 * **Дякую!**
 ...
 * Ви отримаєте ідентичну структуру каталогів і файли в межах `es` і `de` , як і в `en`
 ...
 Hokeylizer справляється з проблемами досить добре, але з файлами уцінки часто виникають такі проблеми:
