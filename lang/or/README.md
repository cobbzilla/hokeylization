 ...
 * [npm ରେ hokeylization](https://www.npmjs.com/package/hokeylization)
 ...
 ଯଦି ଆପଣ ଏହି ସଫ୍ଟୱେର୍ ବ୍ୟବହାର କରିବାକୁ ଉପଭୋଗ କରନ୍ତି, ତେବେ ମୁଁ ଗ୍ରହଣ କରି ବହୁତ ଖୁସି ହେବି |
 ...
 * ଏକ "କ translate ଣସି ଅନୁବାଦ" ରାପର୍ ଟେକ୍ସଟ୍ ଚାରିପାଖରେ `backticks` ମଧ୍ୟରେ ରଖାଯିବ ଯେ ସେଗୁଡିକ ଅନୁବାଦ ହୋଇନାହିଁ |
 ...
 ନିମ୍ନଲିଖିତ ସ୍ଥାନଗୁଡ଼ିକରେ `filter` ସ୍କ୍ରିପ୍ଟ ଖୋଜାଯିବ ( `.js` ସହିତ ଫିଲ୍ଟରରେ ଯୋଡ଼ାଯିବ |
 ନାମ, ଯଦି ଏହା ପୂର୍ବରୁ `.js` ରେ ସମାପ୍ତ ହୁଏ)
 ...
 * ବିଲ୍ଟ-ଇନ୍ [ଫିଲ୍ଟର ଡିରେକ୍ଟୋରୀ](https://github.com/cobbzilla/hokeylization/tree/master/util/filter)
 ...
 #### ପାରାମିଟରଗୁଡିକ ଫିଲ୍ଟର୍ କରନ୍ତୁ |
 `filter` ଷ୍ଟ୍ରିଙ୍ଗ୍ ଏକାଧିକ ଶବ୍ଦ ହୋଇପାରେ | ଏହି କ୍ଷେତ୍ରରେ, ପ୍ରଥମ ଶବ୍ଦ ହେଉଛି ଫିଲ୍ଟର ନାମ, ଏବଂ |
 ଅବଶିଷ୍ଟ ଶବ୍ଦଗୁଡ଼ିକ `filter` ଫଙ୍କସନ୍ ପାଇଁ ଆର୍ଗୁମେଣ୍ଟସ୍ ଭାବରେ ପାସ୍ ହେବ |
