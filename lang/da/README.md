 ...
 * en mappe med filer, rekursivt
 ...
 Dette README.md-dokument er blevet oversat ved hjælp af selve hokeyliseringsværktøjet,
 til **[alle sprog, der understøttes af Google Translate](../README.md)!**
 ...
 * Du vil ende med en identisk mappestruktur og filer inden for `es` og `de` som du har under `en`
 ...
 Hokeylizer håndterer tingene anstændigt godt, men med markdown-filer kan du ofte disse problemer:
