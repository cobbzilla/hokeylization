ہوکیلائزیشن
 =============
 نام ایک پورٹ مینٹیو ہے، جس کا مطلب ہے 'ہکی لوکلائزیشن'

 یہ ہوکی ہے کیونکہ یہ بہت آسان ہے: یہ گوگل ٹرانسلیٹ کو تار بھیجتا ہے۔

 آپ ترجمہ کر سکتے ہیں:
 * پیغامات پر مشتمل ایک جاوا اسکرپٹ آبجیکٹ
 * فائلوں کی ڈائرکٹری، بار بار

 # اسے دوسری زبان میں پڑھیں
 اس README.md دستاویز کا ترجمہ کیا گیا ہے، ہوکیلائزیشن ٹول کا استعمال کرتے ہوئے،
 **[گوگل ٹرانسلیٹ کے ذریعے تعاون یافتہ ہر زبان](../README.md) میں!**
 ...
 **[📚 ... تمام زبانیں ...](../README.md)**
 ...
 اصل کا یہ خاص ترجمہ [README](https://github.com/cobbzilla/yuebing/blob/master/README.md)
 غلطی ہو سکتی ہے -- *تصحیح بہت خوش آئند ہے!* براہ کرم [GitHub پر پل کی درخواست] (https://github.com/cobbzilla/yuebing/pulls) بھیجیں،
 یا اگر آپ ایسا کرنے میں آرام سے نہیں ہیں تو، [ایک مسئلہ کھولیں](https://github.com/cobbzilla/yuebing/issues)
 ...
 * برائے مہربانی بہتر ترجمے کی تجویز پیش کریں۔
 *** آپ کا شکریہ!**
 ...
 * [این پی ایم پر ہوکیلائزیشن](https://www.npmjs.com/package/hokeylization)
 ...
 آپ فائلوں کی ڈائرکٹری کا ترجمہ بھی کر سکتے ہیں۔ ہوکیلائزیشن بار بار ہر ایک کا دورہ کرے گی۔
 ...
 **بڑی وارننگ**: ڈائریکٹریز کا ترجمہ کرتے وقت، **نہ کریں** آؤٹ پٹ ڈائرکٹری کی وضاحت کریں
 یہ آپ کی ان پٹ ڈائرکٹری میں ہے! اگر آپ ایسا کرتے ہیں، تو آپ کریں گے:
 * لامحدود تکرار دلانا
 * اپنا گوگل بل چلائیں۔
 * اپنی ڈسک کو بھریں۔
 * کم مزہ کریں۔
 ...
 * آپ کو `es` اور `de` کے اندر ایک جیسی ڈائرکٹری ڈھانچہ اور فائلیں ملیں گی جیسا کہ آپ کے پاس `en` کے تحت ہے۔
 ...
 ### شامل نہیں۔
 کبھی کبھی آپ کا `-m` بہت ساری فائلوں سے میل کھاتا ہے۔ واضح طور پر خارج کرنے کے لیے `-e` / `--excludes` اختیار استعمال کریں۔
 ...
 Hokeylizer چیزوں کو اچھی طرح سے ہینڈل کرتا ہے، لیکن مارک ڈاؤن فائلوں کے ساتھ، آپ کو اکثر یہ مسائل پیش آ سکتے ہیں:
 ...
 * ایک "ترجمہ نہیں" ریپر کو `backticks` کے اندر متن کے گرد رکھا جائے گا تاکہ یہ یقینی بنایا جا سکے کہ ان کا ترجمہ نہیں کیا گیا ہے۔
 ...
 اس طرح، آپ کو اس پر مکمل کنٹرول حاصل ہے کہ آخر میں کیا لکھا جائے گا۔
