 ...
 * директория с файлове, рекурсивно
 ...
 Този документ README.md е преведен с помощта на самия инструмент за хокейлизиране,
 на **[всеки език, поддържан от Google Translate](../README.md)!**
 ...
 * любезно предложете предложение за по-добър превод
 * **Благодаря ти!**
 ...
 * В крайна сметка ще получите идентична структура на директория и файлове в рамките на `es` и `de` , каквито имате под `en`
 ...
 Hokeylizer се справя с нещата прилично добре, но с файловете за маркиране често може да имате следните проблеми:
