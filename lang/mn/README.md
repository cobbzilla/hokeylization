Хокейлжилт
 =============
 Энэ нэр нь портманто бөгөөд "хокей нутагшуулах" гэсэн утгатай.

 Энэ нь маш энгийн, учир нь энэ нь hokey юм: энэ нь Google Translate руу мөр илгээдэг

 Та орчуулж болно:
 * мессеж агуулсан JavaScript объект
 * рекурсив файлуудын лавлах

 # Үүнийг өөр хэлээр уншина уу
 Энэхүү README.md баримтыг hokeylization хэрэгслийг ашиглан орчуулсан.
 **[Google Translate дэмждэг бүх хэл](../README.md) руу!**
 ...
 * илүү сайн орчуулгын саналыг санал болгоно уу
 * **Баярлалаа!**
 ...
 * Та `en`-д байгаа шиг `en` `es` болон `de` доторх ижил лавлах бүтэц, файлуудтай байх болно.
 ...
 Hokeylizer нь бүх зүйлийг сайн зохицуулдаг, гэхдээ тэмдэглэгээний файлуудын тусламжтайгаар та ихэвчлэн дараах асуудлуудтай тулгардаг:
 ...
 * "Орчуулахгүй" гэсэн `backticks` доторх текстийн эргэн тойронд байрлуулж, тэдгээр нь орчуулагдахгүй байх болно.
 ...
 Файлуудыг диск рүү бичихээс өмнө файлын агуулгыг бүхэлд нь `filter` функцэд мөр болгон дамжуулна.

 `filter` буцах утга нь хадгалах санд бичигдэх зүйл юм

 Ингэснээр та эцэст нь юу бичихийг бүрэн хянах боломжтой болно

 ### Туслаач
 Тусламж үзүүлэхийн тулд `-h` / `--help` -г ашиглана уу

 ## Орчуулгын мэнд хүргэе!
