Hokeyization
 ==============
 Το όνομα είναι portmanteau, που σημαίνει "τοπικός εντοπισμός χοκέι"

 Είναι χιουμοριστικό γιατί είναι πολύ απλό: στέλνει συμβολοσειρές στο Google Translate

 Μπορείτε να μεταφράσετε:
 * ένα αντικείμενο JavaScript που περιέχει μηνύματα
 * ένας κατάλογος αρχείων, αναδρομικά

 # Διαβάστε αυτό σε άλλη γλώσσα
 Αυτό το έγγραφο README.md έχει μεταφραστεί, χρησιμοποιώντας το ίδιο το εργαλείο hokeylization,
 σε **[κάθε γλώσσα που υποστηρίζεται από τη Μετάφραση Google](../README.md)!**
 ...
 **[📚 ... Όλες οι γλώσσες ...](../README.md)**
 ...
 Αυτή η συγκεκριμένη μετάφραση του πρωτότυπου [README](https://github.com/cobbzilla/yuebing/blob/master/README.md)
 μπορεί να είναι ελαττωματικά -- *οι διορθώσεις είναι πολύ ευπρόσδεκτες!* Στείλτε ένα [αίτημα έλξης στο GitHub](https://github.com/cobbzilla/yuebing/pulls),
 ή αν δεν αισθάνεστε άνετα να το κάνετε αυτό, [ανοίξτε ένα θέμα](https://github.com/cobbzilla/yuebing/issues)
 ...
 * Προσφέρετε ευγενικά μια πρόταση για καλύτερη μετάφραση
 * **Ευχαριστώ!**
 ...
 * Θα καταλήξετε με πανομοιότυπη δομή καταλόγου και αρχεία μέσα στα `es` και `de` όπως έχετε στο `en`
 ...
 Το Hokeylizer χειρίζεται τα πράγματα αξιοπρεπώς, αλλά με τα αρχεία μαρκαρίσματος, μπορεί συχνά να αντιμετωπίζετε αυτά τα προβλήματα:
