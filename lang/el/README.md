 ...
 * [hokeylization σε npm](https://www.npmjs.com/package/hokeylization)
 ...
 Εάν σας αρέσει να χρησιμοποιείτε αυτό το λογισμικό, θα χαρώ πολύ να λάβω ακόμη και το
 ...
 * Ένα περιτύλιγμα "χωρίς μετάφραση" θα τοποθετηθεί γύρω από το κείμενο εντός `backticks` για να διασφαλιστεί ότι δεν μεταφράζονται
 ...
 Το σενάριο `filter` θα αναζητηθεί στις ακόλουθες τοποθεσίες (με `.js` θα προστεθεί στο φίλτρο
 ...
 * Ο ενσωματωμένος [κατάλογος φίλτρων](https://github.com/cobbzilla/hokeylization/tree/master/util/filter)
 ...
 #### Παράμετροι φίλτρου
 Η συμβολοσειρά `filter` μπορεί να είναι πολλές λέξεις. Σε αυτήν την περίπτωση, η πρώτη λέξη είναι το όνομα του φίλτρου και
 ...
 *Όταν δημιουργείτε ευρετήρια, μπορείτε να έχετε μόνο μία πηγή εισόδου*
 ...
 Χρησιμοποιήστε το "-A" / " `-A` `--index-template` για να προσδιορίσετε πώς μορφοποιείται η έξοδος ευρετηρίου. Μπορείτε να ορίσετε 'html',
