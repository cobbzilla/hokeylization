 ...
 **[📚 ... ทุกภาษา ...](../README.md)**
 ...
 การแปลเฉพาะของต้นฉบับ [README](https://github.com/cobbzilla/hokeylization/blob/master/README.md)
 อาจมีข้อบกพร่อง -- * ยินดีเป็นอย่างยิ่งที่จะแก้ไข! * โปรดส่ง [คำขอดึงข้อมูลบน GitHub](https://github.com/cobbzilla/hokeylization/pulls)
 หรือหากคุณไม่สะดวกใจที่จะทำเช่นนั้น [เปิดปัญหา](https://github.com/cobbzilla/hokeylization/issues)
 ...
 * [hokeylization บน npm](https://www.npmjs.com/package/hokeylization)
 ...
 หากคุณสนุกกับการใช้ซอฟต์แวร์นี้ ฉันยินดีเป็นอย่างยิ่งที่จะได้รับ
 ...
 * เสื้อคลุม "ไม่มีการแปล" จะถูกวางไว้รอบข้อความภายใน `backticks` เพื่อให้แน่ใจว่าไม่ได้แปล
 ...
 สคริปต์ `filter` ตัวกรอง" จะถูกค้นหาในตำแหน่งต่อไปนี้ (โดยจะมี `.js` ต่อท้ายตัวกรอง
 ...
 * ในตัว [ไดเรกทอรีตัวกรอง](https://github.com/cobbzilla/hokeylization/tree/master/util/filter)

 #### พารามิเตอร์ตัวกรอง
 สตริง `filter` สามารถมีได้หลายคำ ในกรณีนี้ คำแรกคือชื่อตัวกรอง และ
