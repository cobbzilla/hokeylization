 ...
 **[Google Translate тарабынан колдоого алынган ар бир тилге](../README.md)!**
 ...
 * Сиз `es` жана `de` ичинде окшош каталог түзүмүнө жана файлдарга ээ `en`
 ...
 Hokeylizer нерселерди жакшы чечет, бирок белгилөө файлдары менен сиз көп учурда бул көйгөйлөрдү пайда кылышыңыз мүмкүн:
