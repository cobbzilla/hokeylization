होकेलाइज़ेशन
 =============
 नाम एक बंदरगाह है, जिसका अर्थ है 'होकी स्थानीयकरण'

 यह बहुत आसान है क्योंकि यह बहुत आसान है: यह Google अनुवाद को तार भेजता है

 आप अनुवाद कर सकते हो:
 * संदेश युक्त एक जावास्क्रिप्ट वस्तु
 * फाइलों की एक निर्देशिका, पुनरावर्ती

 #इसे दूसरी भाषा में पढ़ें
 इस README.md दस्तावेज़ का अनुवाद होकेलाइज़ेशन टूल का उपयोग करके किया गया है,
 में **[Google अनुवाद द्वारा समर्थित प्रत्येक भाषा](../README.md)!**
 ...
 **[📚 ... सभी भाषाएं ...](../README.md)**
 ...
 मूल [README](https://github.com/cobbzilla/yuebing/blob/master/README.md) का यह विशेष अनुवाद
 त्रुटिपूर्ण हो सकता है -- *सुधारों का बहुत स्वागत है!* कृपया [GitHub पर पुल अनुरोध](https://github.com/cobbzilla/yuebing/pulls) भेजें,
 या यदि आप ऐसा करने में सहज नहीं हैं, तो [एक मुद्दा खोलें](https://github.com/cobbzilla/yuebing/issues)
 ...
 *कृपया एक बेहतर अनुवाद का सुझाव दें
 * **आपको धन्यवाद!**
 ...
 * आप एक समान निर्देशिका संरचना और फाइलों के साथ `es` और `de` के साथ समाप्त होंगे जैसे आपके पास `en` के तहत है
 ...
 Hokeylizer चीजों को अच्छी तरह से संभालता है, लेकिन मार्कडाउन फाइलों के साथ, आपको कई बार ये समस्याएं हो सकती हैं:
 ...
 * यह सुनिश्चित करने के लिए कि उनका अनुवाद नहीं किया गया है, `backticks` के भीतर पाठ के चारों ओर "कोई अनुवाद नहीं" आवरण रखा जाएगा
 ...
 ### फ़िल्टर
 साहसी के लिए: किसी निर्देशिका में फ़ाइलों को संसाधित करते समय, आप `-F` / `--filter` विकल्प पास कर सकते हैं
 ...
 फ़ाइलों को डिस्क पर लिखे जाने से पहले, संपूर्ण फ़ाइल सामग्री `filter` फ़ंक्शन को एक स्ट्रिंग के रूप में पास कर दी जाएगी
