هوکیلیزاسیون
 ==============
 نام پورمانتو است، به معنی "محلی سازی هوکی"

 بسیار ساده است: رشته هایی را به مترجم گوگل می فرستد

 می توانید ترجمه کنید:
 * یک شی جاوا اسکریپت حاوی پیام
 * فهرستی از فایل ها، به صورت بازگشتی

 # این را به زبان دیگری بخوانید
 این سند README.md با استفاده از خود ابزار hokeylization ترجمه شده است.
 به **[هر زبان پشتیبانی شده توسط Google Translate](../README.md)!**

 من مطمئنم که کامل نیست، اما امیدوارم از هیچی بهتر باشد!

 [🇸🇦 عربی](../ar/README.md)
 [🇧🇩 بنگالی](../bn/README.md)
 [🇩🇪 آلمانی] (lang/de/README.md)
 [🇺🇸 انگلیسی](../en/README.md)
 [🇪🇸 اسپانیایی] (lang/es/README.md)
 [🇫🇷 فرانسوی] (lang/fr/README.md)
 [🇹🇩 هاوسا](../ha/README.md)
 [🇮🇳 هندی](../hi/README.md)
 [🇮🇩 اندونزیایی] (lang/id/README.md)
 [🇮🇹 ایتالیایی](../it/README.md)
 [🇯🇵 ژاپنی] (lang/ja/README.md)
 [🇰🇷 کره ای] (lang/ko/README.md)
 ...
 [🇹🇷 ترکی](../tr/README.md)
 [🇵🇰 اردو] (lang/ur/README.md)
 [🇻🇳 ویتنامی] (lang/vi/README.md)
 [🇨🇳 چینی](../zh/README.md)
 ...
 * لطفاً پیشنهاد ترجمه بهتری را ارائه دهید
 * **متشکرم!**
 ...
 * صورت حساب Google خود را اجرا کنید
 * دیسک خود را پر کنید
 * کمتر تفریح کنید
 ...
 چه اتفاقی می افتد زمانی که موارد بالا اجرا می شود:
 ...
 * در نهایت با ساختار دایرکتوری و فایل‌های یکسانی در `es` » و `de` مانند `en`
 ...
 Hokeylizer به خوبی کارها را انجام می دهد، اما با فایل های علامت گذاری، اغلب ممکن است این مشکلات را داشته باشید:
 ...
 * یک بسته بندی "بدون ترجمه" در اطراف متن در `backticks` قرار می گیرد تا اطمینان حاصل شود که آنها ترجمه نمی شوند.
 ...
 تابع `filter` فیلتر» باید `async` زیرا `await` انتظار» از آن فراخوانی می‌شود

 قبل از اینکه فایل‌ها روی دیسک نوشته شوند، کل محتوای فایل به‌عنوان یک رشته به تابع `filter` می‌شود

 مقدار بازگشتی از تابع `filter` همان چیزی است که در فضای ذخیره سازی نوشته می شود
