ਹੋਕੀਲਾਈਜ਼ੇਸ਼ਨ
 ==============
 ਨਾਮ ਇੱਕ ਪੋਰਟਮੈਨਟੇਉ ਹੈ, ਜਿਸਦਾ ਅਰਥ ਹੈ 'ਹੋਕੀ ਸਥਾਨਕਕਰਨ'

 ਇਹ ਹੋਕੀ ਹੈ ਕਿਉਂਕਿ ਇਹ ਬਹੁਤ ਸਰਲ ਹੈ: ਇਹ ਗੂਗਲ ਟ੍ਰਾਂਸਲੇਟ ਨੂੰ ਸਤਰ ਭੇਜਦਾ ਹੈ

 ਤੁਸੀਂ ਅਨੁਵਾਦ ਕਰ ਸਕਦੇ ਹੋ:
 * ਇੱਕ JavaScript ਵਸਤੂ ਜਿਸ ਵਿੱਚ ਸੁਨੇਹੇ ਹਨ
 * ਫਾਈਲਾਂ ਦੀ ਇੱਕ ਡਾਇਰੈਕਟਰੀ, ਵਾਰ-ਵਾਰ

 # ਇਸਨੂੰ ਕਿਸੇ ਹੋਰ ਭਾਸ਼ਾ ਵਿੱਚ ਪੜ੍ਹੋ
 ਇਸ README.md ਦਸਤਾਵੇਜ਼ ਦਾ ਅਨੁਵਾਦ ਹੋਕੀਲਾਈਜ਼ੇਸ਼ਨ ਟੂਲ ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਕੀਤਾ ਗਿਆ ਹੈ,
 **[Google ਅਨੁਵਾਦ ਦੁਆਰਾ ਸਮਰਥਿਤ ਹਰੇਕ ਭਾਸ਼ਾ](../README.md) ਵਿੱਚ!**
 ...
 * ਕਿਰਪਾ ਕਰਕੇ ਇੱਕ ਬਿਹਤਰ ਅਨੁਵਾਦ ਦਾ ਸੁਝਾਅ ਪੇਸ਼ ਕਰੋ
 * **ਤੁਹਾਡਾ ਧੰਨਵਾਦ!**
 ...
 * [npm 'ਤੇ ਹੋਕੀਲਾਈਜ਼ੇਸ਼ਨ](https://www.npmjs.com/package/hokeylization)
 ...
 ਜੇਐਸ ਆਬਜੈਕਟ ਦੇ ਅੰਤ ਤੱਕ. ਪੂਰੀ ਫਾਈਲ ਹਮੇਸ਼ਾ ਦੁਬਾਰਾ ਲਿਖੀ ਜਾਂਦੀ ਹੈ।
 ...
 * ਤੁਸੀਂ `es` ਅਤੇ `de` ਦੇ ਅੰਦਰ ਇੱਕ ਸਮਾਨ ਡਾਇਰੈਕਟਰੀ ਢਾਂਚੇ ਅਤੇ ਫਾਈਲਾਂ ਦੇ ਨਾਲ ਖਤਮ ਹੋਵੋਗੇ ਜਿਵੇਂ ਕਿ ਤੁਹਾਡੇ ਕੋਲ `en` ਦੇ ਹੇਠਾਂ ਹੈ
 ...
 Hokeylizer ਚੀਜ਼ਾਂ ਨੂੰ ਚੰਗੀ ਤਰ੍ਹਾਂ ਸੰਭਾਲਦਾ ਹੈ, ਪਰ ਮਾਰਕਡਾਊਨ ਫਾਈਲਾਂ ਦੇ ਨਾਲ, ਤੁਹਾਨੂੰ ਅਕਸਰ ਇਹ ਸਮੱਸਿਆਵਾਂ ਹੋ ਸਕਦੀਆਂ ਹਨ:
 ...
 * ਇਹ ਯਕੀਨੀ ਬਣਾਉਣ ਲਈ ਕਿ ਉਹਨਾਂ ਦਾ ਅਨੁਵਾਦ ਨਹੀਂ ਕੀਤਾ ਗਿਆ ਹੈ, `backticks` ਦੇ ਅੰਦਰ ਟੈਕਸਟ ਦੇ ਦੁਆਲੇ ਇੱਕ "ਨੋ ਅਨੁਵਾਦ" ਰੈਪਰ ਰੱਖਿਆ ਜਾਵੇਗਾ
 ...
 'ਫਿਲਟਰ' ਫੰਕਸ਼ਨ `async` `filter` ' ਹੋਣਾ ਚਾਹੀਦਾ ਹੈ ਕਿਉਂਕਿ `await` ਨੂੰ ਇਸ 'ਤੇ ਕਾਲ ਕੀਤਾ ਜਾਵੇਗਾ

 ਫਾਈਲਾਂ ਨੂੰ ਡਿਸਕ ਤੇ ਲਿਖੇ ਜਾਣ ਤੋਂ ਪਹਿਲਾਂ, ਸਾਰੀ ਫਾਈਲ ਸਮੱਗਰੀ ਨੂੰ ਇੱਕ ਸਤਰ ਦੇ ਰੂਪ ਵਿੱਚ `filter` ਫੰਕਸ਼ਨ ਵਿੱਚ ਪਾਸ ਕੀਤਾ ਜਾਵੇਗਾ

 `filter` ਫੰਕਸ਼ਨ ਤੋਂ ਵਾਪਸੀ ਮੁੱਲ ਉਹ ਹੈ ਜੋ ਅਸਲ ਵਿੱਚ ਸਟੋਰੇਜ ਵਿੱਚ ਲਿਖਿਆ ਜਾਵੇਗਾ
