 ...
 * [npm-ൽ ഹോക്കിലൈസേഷൻ](https://www.npmjs.com/package/hokeylization)
 ...
 നിങ്ങൾ ഈ സോഫ്‌റ്റ്‌വെയർ ഉപയോഗിക്കുന്നത് ആസ്വദിക്കുകയാണെങ്കിൽ, അത് ലഭിക്കുന്നതിൽ ഞാൻ വളരെ സന്തുഷ്ടനാണ്
 ...
 * വിവർത്തനം ചെയ്തിട്ടില്ലെന്ന് ഉറപ്പാക്കാൻ, `backticks` ടെക്‌സ്‌റ്റിന് ചുറ്റും "വിവർത്തനം വേണ്ട" റാപ്പർ സ്ഥാപിക്കും.
 ...
 ഇനിപ്പറയുന്ന ലൊക്കേഷനുകളിൽ `filter` സ്ക്രിപ്റ്റ് തിരയപ്പെടും ( `.js` ഉപയോഗിച്ച് ഫിൽട്ടറിൽ ചേർക്കും
 പേര്, അത് ഇതിനകം `.js` ൽ അവസാനിക്കുന്നില്ലെങ്കിൽ)
 * നിലവിലെ ഡയറക്‌ടറി
 ...
 * അന്തർനിർമ്മിത [ഫിൽട്ടറുകൾ ഡയറക്ടറി](https://github.com/cobbzilla/hokeylization/tree/master/util/filter)
 ...
 `filter` സ്ട്രിംഗ് ഒന്നിലധികം വാക്കുകളാകാം. ഈ സാഹചര്യത്തിൽ, ആദ്യ വാക്ക് ഫിൽട്ടർ നാമമാണ്, കൂടാതെ
 ശേഷിക്കുന്ന വാക്കുകൾ `filter` ഫംഗ്‌ഷനിലേക്ക് ആർഗ്യുമെന്റുകളായി കൈമാറും
 ...
 *സൂചികകൾ സൃഷ്ടിക്കുമ്പോൾ, നിങ്ങൾക്ക് ഒരു ഇൻപുട്ട് ഉറവിടം മാത്രമേ ഉണ്ടാകൂ*
 ...
 അല്ലെങ്കിൽ ഒരു ഡയറക്ടറി. ഇതൊരു ഡയറക്‌ടറി ആണെങ്കിൽ, ടെംപ്ലേറ്റിനെ അടിസ്ഥാനമാക്കി ഒരു ഡിഫോൾട്ട് ഫയൽനാമം ഉപയോഗിക്കും (ചുവടെ കാണുക)
