export default {
  ...
  err_readMessageKeys_invalidFileStart: 'readMessageKeys: күтүлгөн файл {{ file }} "экспорттун демейки" же "module.exports" менен башталат, бирок табылган: {{actualPrefix}} ...',
