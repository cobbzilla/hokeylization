export default {
  ...
  err_filter_loading: 'Filter ikke funnet: {{ filter }}\n Filteret ble ikke funnet i noen av: den gjeldende katalogen, ./.hokey-filters-katalogen, ${HOME}/.hokey-filters-katalogen eller den innebygde filterkatalogen'
}