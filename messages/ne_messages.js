export default {
  ...
  err_readMessageKeys_invalidFileStart: 'readMessageKeys: अपेक्षित फाइल {{ file }} \'निर्यात पूर्वनिर्धारित\' वा \'module.exports\' सँग सुरु हुन सक्छ तर फेला पर्यो: {{actualPrefix}}',
  ...
  info_option_excludes: 'डाइरेक्टरी प्रशोधन गर्दा, स्पष्ट रूपमा यी रेगेक्सहरूसँग मेल खाने फाइलहरू बहिष्कृत गर्नुहोस्, भले ही तिनीहरू `-m` / `--match` regex सँग मेल खान्थे।',
  ...
  info_option_languages: 'भाषाहरूमा अनुवाद गर्नका लागि ISO कोडहरूको अल्पविराम-विभाजित सूची',
  ...
  err_readDirFiles_mkdir: 'readDirFiles( {{dir}} ): डाइरेक्टरीमा फाइलहरू सूचीबद्ध गर्ने प्रयास गर्दा त्रुटि भयो: {{e}}',
