export default {
  ...
  info_arg_source: 'د ژباړې سرچینه؛ کیدای شي د JS فایل یا د ژباړې لپاره د فایلونو لارښود وي',
