export default {
  ...
  err_cannotWriteSource: 'рад кардани дубора навиштани манбаи вуруд (бо забонҳои баромад нишон дода шудааст): {{source}}',
  ...
  info_option_dryRun: 'Ба Google Translate ягон файл нанависед ё ягон API занг назанед, аммо қайд кунед, ки чӣ кор карда мешуд',
